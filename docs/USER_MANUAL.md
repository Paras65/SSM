...
- **शून्य-जटिलता उपयोगकर्ता अनुभव (Zero-Friction / No API Key Burden)**:
  - साधारण आचार्यों या स्कूल ऑपरेटरों को किसी भी तकनीकी API Key, पासवर्ड या जटिल सेटअप की आवश्यकता नहीं होती।
  - फोटो खींचते ही सिस्टम स्वतः स्प्लिट-स्क्रीन (Split-Screen) मोड में खुलता है।
...
- **Google Gemini 2.5 Flash विज़न OCR (पृष्ठभूमि AI एकीकरण)**:
  - यदि सर्वर पर्यावरण (`.env`) अथवा उन्नत सेटिंग्स में Google Gemini Key उपलब्ध है, तो AI हस्तलिखित और मुद्रित हिंदी रजिस्टरों को पढ़कर सीधे कॉलम (रोल नं., छात्र नाम, पिता का नाम, कक्षा, वर्ग, मोबाइल) स्वतः भर देता है।
  - यदि AI कुंजी उपलब्ध न हो, तो भी स्प्लिट-स्क्रीन फोटो देखकर 1 मिनट में 20 छात्रों की मैन्युअल प्रविष्टि 100% सुचारू रहती है।
- **उन्नत AI सेटिंग्स (वैकल्पिक)**: मोडल के निचले भाग में आईटी व्यवस्थापकों हेतु एक सूक्ष्म `⚙️ उन्नत AI सेटिंग्स` विकल्प दिया गया है, जो आम उपयोगकर्ताओं को विचलित नहीं करता।
