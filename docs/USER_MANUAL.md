...
### 38.1 🎯 पाठ्यक्रम प्रगति एवं मासिक चयन (Course Progress & Monthly Scope)
- **परीक्षा प्रकार चयन**:
...
- **पूर्णांक एवं समय निर्धारण**:
  - इकाई मूल्यांकन हेतु 15, 20 या 25 अंक (समय: 40 या 45 मिनट)।
  - त्रैमासिक परीक्षा हेतु 40 या 50 अंक (समय: 90 या 120 मिनट)।
...
- **सहेजी गई API Key का स्वतः उपयोग**:
  ...
  - यदि किसी शाखा या शिक्षक को अपनी व्यक्तिगत कुंजी दर्ज करनी हो, तो वे **`🔑 API Key`** बटन पर क्लिक करके सीधे अपनी कुंजी सहेज सकते हैं।
- **विशिष्ट विषय एवं प्रॉम्प्ट फोकस (Custom Topic / Prompt)**:
  - शिक्षक सामान्य पाठ्यक्रम के अतिरिक्त किसी विशिष्ट पाठ (उदा. *'कबीर के दोहे'*, *'प्रकाश का परावर्तन'*, *'त्रिकोणमिति'*) का नाम लिखकर **`✨ Gemini AI से बनाएं`** बटन दबा सकते हैं।
- **स्वचालित विद्या भारती ब्लूप्रिंट संरेखण**:
