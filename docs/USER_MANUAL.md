...
### 20.2 नेटवर्क टैब सुरक्षा एवं न्यूनतम डेटा फ़ेचिंग मानक (Network Tab Privacy & Minimal API Fetching - Rule 10)
SSM ERP प्रणाली ब्राउज़र के Network टैब में संवेदनशील डेटा रिसाव (Data Leakage) को रोकने एवं बैंडविड्थ दक्षता सुनिश्चित करने हेतु **न्यूनतम विशेषाधिकार (Least-Privilege Minimal Data Fetching)** सिद्धांत पर संचालित होती है:

1. **पोर्टल-वार कंडीशनल डेटा लोडिंग (Portal-Scoped Conditional Loading)**:
   - **सार्वजनिक होमपेज (`/`)**: सार्वजनिक पृष्ठों पर केवल विद्यालय शाखा सूची (लोकेटर हेतु) एवं सार्वजनिक सूचनाएं (Notice Board हेतु) ही लोड होती हैं। किसी भी छात्र की निजी पंजिका (`/api/students`), उपस्थिति (`/api/attendance`), शुल्क वित्तीय लेजर (`/api/fees`), अथवा प्रगति पत्र (`/api/reports`) कभी भी सार्वजनिक पृष्ठ पर कॉल नहीं होते।
   - **छात्र एवं अभिभावक पोर्टल (`/student`)**: छात्र लॉगिन के पश्चात केवल संबंधित छात्र का स्वयं का अधिकृत रिकॉर्ड (`/api/students/me`) फ़ेच होता है; विद्यालय के अन्य छात्रों का डेटा कभी भी नेटवर्क पर प्रसारित नहीं होता।
   - **व्यवस्थापक एवं शिक्षक पोर्टल**: संपूर्ण कक्षा या शाखा का डेटा केवल तब फ़ेच होता है जब अधिकृत उपयोगकर्ता व्यवस्थापक या शिक्षक पोर्टल में सक्रिय रूप से कार्य कर रहा हो (`viewMode === 'admin' || viewMode === 'teacher'`)।

2. **संवेदनशील क्रेडेंशियल एवं पासवर्ड का पूर्ण बहिष्करण (Cryptographic Credential Stripping)**:
   - **प्रशासक सुरक्षा पासकोड (`adminPasscode`)**: नवीन विद्यालय पंजीकरण (`POST /api/schools`) एवं विवरण अद्यतन (`PUT /api/schools/:id`) के समय पासवर्ड को Scrypt द्वारा हैश किया जाता है तथा किसी भी स्थिति में प्रतिक्रिया (JSON response) में ब्राउज़र को वापस नहीं भेजा जाता (`.select('-adminPasscode')`)।
   - **आचार्य/कर्मचारी सुरक्षा पिन (`pin`)**: आचार्य निर्माण (`POST /api/staff`), संपादन (`PUT /api/staff/:id`), एवं प्रशासनिक सूची (`GET /api/staff`) में से सुरक्षा पिन को नेटवर्क पेलोड से पूरी तरह हटा दिया जाता है (`.select('-pin')`)।
   - **छात्र सुरक्षा पिन (`pin`)**: छात्र प्रवेश, संपादन, बल्क इम्पोर्ट (`/api/students/bulk`), तथा छात्र लॉगिन (`/api/auth/student-login`) प्रतिक्रियाओं से छात्र सुरक्षा पिन को स्ट्रिप कर दिया जाता है।

3. **ओवरसाइज़्ड पेलोड सुरक्षा (Oversized Payload Safeguards)**:
   - बड़े फोटो एवं अनचाहे फ़ील्ड्स लिस्टिंग स्तर पर न्यूनतम रखे जाते हैं ताकि कम इंटरनेट गति (2G/3G) वाले ग्रामीण क्षेत्रों में भी नेटवर्क अनुरोध तीव्र गति से निष्पादित हों।
