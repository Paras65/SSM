...
### 31.2 हार्ड-कॉपी भौतिक रजिस्टर AI स्कैनर (Direct Hard-Copy Register AI Scanner)
...
- **लाइव कैमरा गाइड (Live Document Viewfinder)**:
  - कंप्यूटर के वेबकैम या मोबाइल फोन के बैक कैमरे से लाइव प्रीव्यू।
  - रजिस्टर के पृष्ठ को सीधा रखने हेतु 'A4 Document Alignment Guide'।
  - रोटेट (`↻`) एवं फ़ाइल अपलोड (`.jpg`, `.png`, `.webp`) विकल्प।
- **Google Gemini 2.5 Flash विज़न OCR**:
  - हस्तलिखित और मुद्रित हिंदी/अंग्रेजी रजिस्टरों को पढ़कर सीधे कॉलम (SR No, छात्र नाम, पिता का नाम, कक्षा, रोल नं., मोबाइल) में वर्गीकृत करता है।
- **साइड-बाय-साइड इंटरेक्टिव स्प्रेडशीट ग्रिड**:
  - बाईं ओर खींची गई रजिस्टर की छवि (ज़ूम व पैन सुविधा के साथ)।
  - दाईं ओर एक्सेल जैसी ग्रिड जिसमें प्रविष्टियों को तुरंत जांचा और सुधारा जा सकता है।
- **1-क्लिक बल्क प्रवेश (1-Click Bulk Enrollment)**: ग्रिड में पुष्टि के बाद 'सभी छात्र दर्ज करें' दबाते ही सभी भैया/बहिन ERP छात्र सूची में पंजीकृत हो जाते हैं।
