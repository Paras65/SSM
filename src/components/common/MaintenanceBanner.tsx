...
export const MaintenanceBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-amber-700 via-orange-600 to-amber-800 text-white px-3 sm:px-4 py-2.5 text-xs sm:text-sm font-semibold flex items-center justify-between shadow-md z-40 sticky top-0 border-b border-amber-400/40 animate-fade-in">
