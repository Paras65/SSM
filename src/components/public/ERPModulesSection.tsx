...
export const ERPModulesSection: React.FC<ERPModulesSectionProps> = ({ onOpenSignUp, onOpenLogin }) => {
  const modules = [
    ...
    },
    {
      ...
      desc: 'सुरक्षित छात्र डेटा प्रबंधन, सीमित पहुँच और सामान्य डेटा संरक्षण नियमों के साथ संचालन। इंटरनेट न होने पर भी ऑफलाइन कैशिंग, और शाम को संपूर्ण डेटा का 1-क्लिक सुरक्षित बैकअप।',
      features: ['ऑफलाइन PWA समर्थन', '1-क्लिक JSON बैकअप व रीस्टोर', 'सुरक्षित डेटा पहुँच']
    }
  ];
