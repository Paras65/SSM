  ...
  const masterPillars: MasterPillar[] = [
    {
      ...
      workflows: [
        ...
        {
          icon: Receipt,
          title: 'शुल्क काउंटर, डिजिटल ईमेल रसीद व DCR रोकड़ बही',
          desc: '↵ Enter दबाकर तुरंत छात्र खोजें, पक्की रसीद काटें और अभिभावकों को स्वतः ईमेल रसीद भेजें। शाम को नोटों का भौतिक मिलान कर A4 ऑडिट-रेडी रोकड़ बही प्रिंट करें।',
          badge: 'Sec 13.9, 33'
        },
        {
          icon: Bus,
